...
path_training_label_maps = '/home/turja/DCAN_roi3_WM'
# path of directory where the models will be saved during training
path_model_dir = '/home/turja/DCAN_training_new_2161_72'
...
path_generation_labels =  [0, 14, 15, 16, 172, 2, 3, 4, 8, 10, 11, 12, 13, 17, 18, 21, 26, 28, 41, 42, 43, 47, 49, 50, 51, 52, 53, 54, 58, 60, 61]
# set path to segmentation labels (i.e. the ROI to segment and to compute the loss on)
path_segmentation_labels = [0, 14, 15, 16, 172, 2, 3, 4, 8, 10, 11, 12, 13, 17, 18, 21, 26, 28, 41, 42, 43, 47, 49, 50, 51, 52, 53, 54, 58, 60, 61]
...
n_channels = 2  # here we work in the uni-modal case, so we synthetise only one channel
...
training(labels_dir=path_training_label_maps,
         ...
         load_model_file='/home/turja/DCAN_training_new_2161/dice_072.h5'
         )